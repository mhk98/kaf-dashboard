  ...
  return (
    <div className="bg-white rounded-xl shadow overflow-hidden">
      <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-4 py-3">
        <span className="text-gray-800 font-semibold text-sm">Products</span>
        <button
          onClick={onViewAll}
          className="bg-gray-900 hover:bg-gray-800 text-white text-xs font-medium px-3 py-1 rounded-full transition"
        >
          View All
        </button>
      </div>
