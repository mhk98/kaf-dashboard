...
function installMetaPixel() {
  ...
  if (!document.querySelector("script[data-kaflifestyle-meta-pixel]")) {
    const script = document.createElement("script");
    script.async = true;
    script.src = "https://connect.facebook.net/en_US/fbevents.js";
    script.dataset.kaflifestyleMetaPixel = "true";
...
function installTiktokPixel() {
  ...
  ttq.load = (pixelCode, options = {}) => {
    ...
    script.dataset.kaflifestyleTiktokPixel = pixelCode;
    document.head.appendChild(script);
  };
}
...
function installGoogleTag(conversionId) {
  ...
  if (!document.querySelector("script[data-kaflifestyle-google-tag]")) {
    const script = document.createElement("script");
    script.async = true;
    script.src = `https://www.googletagmanager.com/gtag/js?id=${encodeURIComponent(conversionId)}`;
    script.dataset.kaflifestyleGoogleTag = "true";
    document.head.appendChild(script);
